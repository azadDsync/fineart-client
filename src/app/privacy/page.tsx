    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Welcome to FineArt Club. We respect your privacy and are committed
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            ...
            <li>
              <strong>Profile Data:</strong> Profile picture, bio, interests,
              preferences
            </li>
            <li>
            ...
            <li>
              <strong>Content Data:</strong> Artwork, paintings, comments, and
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            <li>
              <strong>Other Members:</strong> Your profile, artwork, and public
              activities are visible to other club members
            </li>
            <li>
              <strong>Service Providers:</strong> Third-party vendors who help
              us operate the platform (e.g., cloud hosting, email services)
            </li>
            <li>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            ...
            account, we will remove your personal data, though some information
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            ...
            <li>
              <strong>Withdraw Consent:</strong> Withdraw consent where we rely
              on it
            </li>
          </ul>
        </CardContent>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p className="text-muted-foreground mb-2">
            ...
            on our platform and store certain information.
          </p>
          <p className="text-muted-foreground">
            Cookies are files with a small amount of data that are sent to your
            browser. You can instruct your browser to refuse all cookies or to
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-1">
            ...
            <li>
              <strong>Email:</strong> Mailgun for transactional emails
            </li>
            <li>
              <strong>Analytics:</strong> For understanding platform usage (if
              applicable)
            </li>
          </ul>
          <p className="text-muted-foreground mt-3">
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Our platform is intended for users aged 13 and above. We do not
