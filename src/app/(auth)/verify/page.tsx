...
import { MailCheck, AlertTriangle, CheckCircle } from "lucide-react";
          ...
          {isInvalidToken && (
            <>
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  The verification link is either invalid or expired. Please
                  request a new one.
                </AlertDescription>
              </Alert>
          ...
          {isVerificationSent && (
            <>
              <p className="text-muted-foreground">
                ...
                it and follow the link to verify your account.
              </p>
              <Button asChild className="w-full mt-2">
