...
export const eventsData: EventItem[] = [
  {
    ...
    shortDate: "Sep 28",
    description:
      "Hands-on session focusing on gesture & proportion with live model guidance.",
    location: "Studio A",
    category: "Workshop",
    time: "10:00 – 13:00",
  },
  {
    ...
    shortDate: "Oct 02",
    description:
      "Explore tonal layering and atmosphere using minimal palettes.",
    location: "Room 3",
  ...
  },
  {
    ...
    shortDate: "Oct 06",
    description:
      "On-location sketching to capture spontaneous scenes and light.",
    location: "Old Town",
    category: "Community",
    time: "09:30 – 11:00",
  },
  {
    ...
    shortDate: "Oct 11",
    description:
      "Peer + mentor critique focusing on narrative cohesion and presentation.",
  ...
  },
  {
    ...
    shortDate: "Oct 15",
    description:
      "Experiment with texture integration across paper, fabric & found material.",
...
export const announcementsData: AnnouncementItem[] = [
  {
    ...
    summary:
      "Submit up to 3 pieces exploring transition, decay, or renewal themes.",
    category: "Call",
    date: "2025-09-19",
    shortDate: "Sep 19",
    pinned: true,
  },
  {
    ...
    summary:
      "We’ve partnered with Atelier Nord for a month-long winter residency.",
  ...
  },
  {
    ...
    summary:
      "One-on-one critique sessions now available with visiting illustrators.",
    category: "Program",
    date: "2025-09-17",
    shortDate: "Sep 17",
  },
  ...
  },
  {
    ...
    summary:
      "Help host the upcoming public open studios & earn exhibition credits.",
    category: "Community",
    date: "2025-09-13",
    shortDate: "Sep 13",
  },
...
export const announcementCategories = Array.from(
  new Set(announcementsData.map((a) => a.category))
);
...
export const alumniDisciplines = Array.from(
  new Set(alumniData.map((a) => a.discipline))
).sort();
export const alumniTags = Array.from(
  new Set(alumniData.flatMap((a) => a.focusTags))
).sort();
